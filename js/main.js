...
(function() {
  var BACKGROUND_COLOR, FRICTION_MAGNITUDE, SPHERE_AUDIO_SENSITIVITY, SPHERE_COUNT, SPHERE_DAMPING, SPHERE_DIFFUSE, SPHERE_MASS, SPHERE_RADIUS, SPHERE_SHININESS, SPHERE_SPECULAR, SPRING_STIFFNESS, TIMESTEP, analyser, animate, audio, audioContext, binCount, camera, createSphere, freqByteData, hemi, i, length, levelBins, levelHistory, levelsCount, levelsData, light, load, renderer, scene, source, spheres, timeByteData, world;
